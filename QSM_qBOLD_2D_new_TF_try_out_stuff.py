...
Dataset_train=np.load("/mnt/d/Brain_Phantom/Patches_no_air_big_GESSE/15GB_1Pnoise_test.npz")
...
#%%
Number=25
QQplt.check_Params_transformed(label_transformed,prediction_transformed,Number,'CNN_Uniform_GESSE_1Pnoise_32Echoes_Params_3d_drop_norm_n16_all3D')
#%%
QQplt.check_Params_transformed_hist(label_transformed,prediction_transformed,'CNN_Uniform_GESSE_1Pnoise_32Echoes_evaluation_3D_drop_norm_n16_all3D')
...
QQplt.check_full_confusion_matrix_normed(label_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_3d_drop_norm_n16_all3D')
