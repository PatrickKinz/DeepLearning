...
#%%
model_params.save("models/"+version+ "Model_2D_image_3D_conv_norm_drop_no_QSM_redone.h5")
np.save('models/'+version+'history_Model_2D_image_3D_conv_norm_drop_no_QSM_redone.npy',history_params.history)
#model_params = keras.models.load_model("models/"+version+ "Model_2D_image_3D_conv_norm_drop_no_QSM.h5")
model_params.summary()
keras.utils.plot_model(model_params, show_shapes=True)
...
QQplt.check_Params_transformed(label_transformed,prediction_transformed,Number,'CNN_Uniform_GESFIDE_16Echoes_Params_3d_drop_norm_no_QSM_redone')

QQplt.check_Params_transformed_hist(label_transformed,prediction_transformed,'CNN_Uniform_GESFIDE_16Echoes_evaluation_3D_drop_norm_no_QSM_redone')
...
label_transformed[0].shape
# add full histogram plot here
QQplt.check_full_confusion_matrix(label_transformed,prediction_transformed,'confusion_test_3d_drop_norm_no_QSM_redone')
QQplt.check_correlation_coef(label_transformed,prediction_transformed,'confusion_test_correlation_coeffs_3d_drop_norm_no_QSM_redone')
