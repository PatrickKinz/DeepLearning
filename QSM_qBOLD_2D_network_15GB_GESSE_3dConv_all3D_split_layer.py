...
model_folder_name = 'model_GESSE_n8_all3D_1P/'
...
#%%
model_params.save('models/' + model_folder_name + "Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF.keras")
np.save('models/' + model_folder_name +'history_Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF.npy',history_params.history)
with open('models/' + model_folder_name +'history_Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF.json', 'w') as f:
    json.dump(history_params.history, f)
#%%

model_params = keras.models.load_model('models/' + model_folder_name + "Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF.keras")
...
print(test_scores)
with open('models/' + model_folder_name +'Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF_test_scores.json', 'w') as f:
    json.dump(test_scores, f)

#print("Test accuracy:", test_scores[1])
#%%
history_params = np.load(version+'history_Model_2D_image_GESSE_3D_conv_norm_drop_n8_all3D_newTF2.npy',allow_pickle=True)
#%%
...
#%%
Number=25
QQplt.check_Params_transformed(label_transformed,prediction_transformed,Number,'CNN_Uniform_GESSE_1Pnoise_32Echoes_Params_3d_drop_norm_n8_all3D_newTF')
#%%
QQplt.check_Params_transformed_hist(label_transformed,prediction_transformed,'CNN_Uniform_GESSE_1Pnoise_32Echoes_evaluation_3D_drop_norm_n8_all3D_newTF')
...
print(label_transformed[0].shape)
# add full histogram plot here
#QQplt.check_full_confusion_matrix(label_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_3d_drop_norm_n8')
#QQplt.check_full_confusion_matrix_autonormed(label_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_3d_drop_norm_n8_autonormed')
#%%
QQplt.check_full_confusion_matrix_normed(label_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_3d_drop_norm_n8_all3D_splitinput')

#QQplt.check_correlation_coef(label_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_correlation_coeffs_3d_drop_norm_n8')
#%%
QQplt.check_full_confusion_matrix_normed(prediction_transformed,prediction_transformed,'confusion_test_GESSE_1Pnoise_3d_drop_norm_n8_all3D_splitinput_pvp')
