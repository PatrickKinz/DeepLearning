...
Dataset_train=np.load("../Brain_Phantom/Patches_no_air_big_GRE_9/15GB_1Pnoise_train_val.npz")
...
#%%
Dataset_test=np.load("../Brain_Phantom/Patches_no_air_big_GRE_9/15GB_1Pnoise_test.npz")
...
version = "no_air_1Pnoise_15GB_GRE/"

# %% Network

input_qBOLD = keras.Input(shape=(30,30,5,1), name = 'Input_qBOLD')
...
reshape_qBOLD = keras.layers.Reshape((30,30,32))(drop_qBOLD_2)
...
#%%
#model_params.save("models/"+version+ "Model_2D_image_GRE_1Pnoise_5Echoes_3D_conv_norm_drop.h5")
#np.save('models/'+version+'history_Model_2D_image_GRE_1Pnoise_5Echoes_3D_conv_norm_drop.npy',history_params.history)
model_params = keras.models.load_model("models/"+version+ "Model_2D_image_GRE_1Pnoise_5Echoes_3D_conv_norm_drop.h5")
model_params.summary()
keras.utils.plot_model(model_params, show_shapes=True)
...
QQplt.check_Params_transformed(label_transformed,prediction_transformed,Number,'CNN_Uniform_GRE_1Pnoise_5Echoes_Params_3d_drop_norm_n16')

QQplt.check_Params_transformed_hist(label_transformed,prediction_transformed,'CNN_Uniform_GRE_1Pnoise_5Echoes_evaluation_3D_drop_norm_n16')
...
label_transformed[0].shape
# add full histogram plot here
QQplt.check_full_confusion_matrix_normed(label_transformed,prediction_transformed,'confusion_test_GRE_1Pnoise_5Echoes_3d_drop_norm_n16')
QQplt.check_correlation_coef(label_transformed,prediction_transformed,'confusion_test_GRE_1Pnoise_5Echoes_correlation_coeffs_3d_drop_norm_n16')
