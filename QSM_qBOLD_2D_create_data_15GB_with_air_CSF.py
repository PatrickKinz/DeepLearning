...
create_images(seg,"../Brain_Phantom/Patches_with_air_big/15GB_1Pnoise_train_val",multiples=4,noise=True)
create_images(seg,"../Brain_Phantom/Patches_with_air_big/15GB_1Pnoise_test",multiples=1,noise=True,step_size=15)
